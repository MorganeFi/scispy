...
def plot_cells_dict(
    ...
    figsize = (figsize_per_ax[0] * ncols,
               figsize_per_ax[1] * nrows)

    fig, axes = plt.subplots(nrows, ncols, figsize=figsize_per_ax)
...
def plot_cells_list(
    ...
    - figsize_per_ax: size of each subplot (tuple)
